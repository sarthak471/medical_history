...
1>create python virtual envinoment [python3.8 -m venv django_env]
...
4>create new django project [django-admin startproject core]
5>create new django app [python manage.py startapp app1]
